    ...
    <div className="min-h-screen bg-[#FFFBE6] flex items-center justify-center p-6 relative">
      ...
      <div className="bg-white p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-md border border-red-100">
        <div className="text-center mb-8">
           ...
           <h2 className="text-3xl font-extrabold text-red-900">Chào mừng trở lại</h2>
           <p className="text-gray-500 mt-2">Đăng nhập để khám phá Việt Nam</p>
        </div>
        ...
        <p className="text-center mt-6 text-gray-600">
          Chưa có tài khoản? <Link to="/register" className="text-red-600 font-bold hover:underline">Đăng ký ngay</Link>
        </p>
      </div>
    </div>
  );
